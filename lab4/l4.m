...
cons = 2^LENGTH - 1;
register_state_x = [0, 1, 1, 1, 1];
register_state_y = [1, 0, 0, 0, 1];
    
register_state_xx = [1, 0, 0, 0, 0];
register_state_yy = [1, 0, 0, 0, 1];

pseudo_random_sequence = generate_pseudo_random_sequence(register_state_x, register_state_y, cons);
modified_sequence = second_generate_pseudo_random_sequence(register_state_xx, register_state_yy, cons);
